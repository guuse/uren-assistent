...
const mockCommits: GitHubCommit[] = [
  { sha: 'abc', message: 'feat: add ESC close', repo: 'octocat/uren-schrijven', branch: 'main', timestamp: '2026-05-20T10:23:00Z', time: '10:23', date: '2026-05-20' },
  { sha: 'def', message: 'fix: drag logic', repo: 'octocat/uren-schrijven', branch: 'main', timestamp: '2026-05-21T11:47:00Z', time: '11:47', date: '2026-05-21' },
]
...
describe('FetchGitHubContextUseCase', () => {
  it('delegates to repository and returns commits', async () => {
    ...
    const result = await useCase.execute('octocat', '2026-05-19', '2026-05-23')
    expect(result).toEqual(mockCommits)
    expect(mockRepo.getCommitsForWeek).toHaveBeenCalledWith('octocat', '2026-05-19', '2026-05-23')
  })
